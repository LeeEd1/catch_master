...
class Order (models.Model):
    ...
    house = models.CharField(max_length=40, null=False, blank=False)
    street = models.CharField(max_length=40, null=False, blank=False, default="")
    ...
    def save(self, *args, **kwargs):
        """
        Override the save method to assign an order number
